...
HTTP_TEST_URL = 'http://www.cctv.com/'
...
def jude_procotol(procotol):
    if procotol is None: return None
    https_pattern = re.compile(r'https')
    http_pattern = re.compile(r'http')
    if https_pattern.match(str(procotol).lower()): return 2
